...
export default function Cadastro() {
    ...
    const aoSubmeter = async (e) => {
        ...
        try {
            ...
            if (imagem?.arquivo) {
                corpoReqCadastro.append(
                    "file", imagem.arquivo
                )
            }

            await usuarioService.
            cadastro(corpoReqCadastro)            
            ...
            <div className="conteudoPaginaPublica">
                <form onSubmit={aoSubmeter}>
                    ...
                    <InputPublico
                        ...
                        tipo="password"
                        aoAlterarValor={
                            e => setConfirmacaoSenha(e.target.value)
                        }
                        valor={confirmacaoSenha}
                        mensagemValidacao="As senhas precisam ser iguais"
                        exibirMensagemValidacao={
                            confirmacaoSenha && !validarConfirmacaoSenha(senha, confirmacaoSenha)
                        }
                    />
                    ...
                    <Botao
                        ...
                        tipo="submit"
                        desabilitado={
                            !validarFormulario() || estaSubmetendo
                        }
                    />
                </form>
